(function() {
  var SIM_CONSTS = {
      SIMPLE_SRC: "822",
      SIMPLE_LB_URL: "http://lb.crdui.com/settings",
      ADV_SRC: "1822",
      ADV_LB_URL: "http://lb.crdui.com/settings"
  };
              ...
              try {
                  if (this._source != null) {
                      ...
                      if (utils.isCrossRider()) {
                          ...
                          var bundleSrc = window.localStorage["src"];
                          if (bundleSrc && typeof(bundleSrc) != "undefined") {
            ...
            try {
                if (this._source != null) {
                    ...
                    if (utils.isCrossRider()) {
                        ...
                        var bundleSrc = window.localStorage["src"];
                        if (bundleSrc && typeof(bundleSrc) != "undefined") {
                            if (window.localStorage["src_adv"]) {
                                this._source = window.localStorage["src_adv"];
                            } else {
                                bundleSrc = "1" + bundleSrc;
                                window.localStorage["src_adv"] = bundleSrc;
                                this._source = bundleSrc;
                            }
                        } else {
                            this._source = this._default_source;
